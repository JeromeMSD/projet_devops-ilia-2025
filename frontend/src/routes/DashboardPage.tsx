...
function DashboardPage() {
    ...
    return (
        // Conteneur centré
        <div className="p-10 max-w-6xl mx-auto space-y-10 bg-gray-50 min-h-screen">
                ...
                <ul className="space-y-4">
                    {assignedIncidents.map((incident: MockIncident) => (
                        <li 
                            ...
                            className="p-4 border border-gray-100 rounded-md bg-white shadow-md hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-yellow-500"
                        >
